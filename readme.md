...
source/
  ...
  views/
    shrinkage-calculator/
      ...
      controls.ts                  DimensionsSection, shape/direction/unit/dim inputs
...
Each tool lives in `source/views/` as a directory of Mithril components,
with a shared `state.ts` for the model layer. Reusable primitives live in
